...
volatile float twoKi = twoKiDef;											// 2 * integral gain (sKi)
...
void MahonyAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, float sampleFreq) {
	float recipNorm;
