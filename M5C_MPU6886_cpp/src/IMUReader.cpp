...
namespace imur{
    ...
    float IMUReader::wrappingYaw(float yaw) { // Determines if a phase wrap/unwrap occured and accounts for it
        static int Nwrap;
    ...
    float IMUReader::wrappingRoll(float roll,float pitch) {
